 ...
 *    require __DIR__.'/../../../vendor/moro/platform-cms/web/action/auth/social.php';
 */
...
Был совершен вход на сайт *<?= $host ?>* под вашим аккаунтом, впервые из социальной сети *<?= $provider ?>*.
